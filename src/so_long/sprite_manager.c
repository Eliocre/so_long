...
t_list	*generate_animright(t_game *game, int i)
{
	...
	{
		nb = ft_itoa(j);
		tmp = ft_strjoin("textures/animright/right/tile", nb);
		free(nb);
...
t_list	*generate_animdown(t_game *game, int i)
{
	...
	{
		nb = ft_itoa(j);
		tmp = ft_strjoin("textures/animdown/down/tile", nb);
		free(nb);
		str = ft_strjoin(tmp, ".xpm");
		free(tmp);
		ft_lstadd_back(&anim, ft_lstnew(mlx_xpm_file_to_image(game->win.mlx,
...
t_list	*generate_animup(t_game *game, int i)
{
	...
	{
		nb = ft_itoa(j);
		tmp = ft_strjoin("textures/animup/up/tile", nb);
		free(nb);
		str = ft_strjoin(tmp, ".xpm");
		free(tmp);
		ft_lstadd_back(&anim, ft_lstnew(mlx_xpm_file_to_image(game->win.mlx,
...
t_list	*generate_animleft(t_game *game, int i)
{
	...
	{
		nb = ft_itoa(j);
		tmp = ft_strjoin("textures/animleft/left/tile", nb);
		free(nb);
		str = ft_strjoin(tmp, ".xpm");
		free(tmp);
		ft_lstadd_back(&anim, ft_lstnew(mlx_xpm_file_to_image(game->win.mlx,
